import type { CareRecipientProfile } from "../../../../../../shared/models/CareRecipientProfile"

/**
 * Local fallback profile for the web stub.
 *
 * Values mirror `services/mock/careRecipientProfileMock.js` on the
 * backend and `CareRecipientProfileMock.margaretChen` on iOS — when
 * the TS contract changes all three must change together.
 *
 * TODO: delete once this page is fetching from
 * `GET /care-recipients/:id/profile` and the backend has seeded at
 * least one recipient in every environment.
 */
export const MOCK_CARE_RECIPIENT_PROFILE_ID =
  "11111111-1111-4111-a111-111111111111"

export const margaretChen: CareRecipientProfile = {
  ...
  dataSources: [
    ...
    { type: "fitbit", status: "not_connected" },
    { type: "garmin", status: "not_connected" },
    { type: "ring", status: "not_connected" },
  ],
  baseline: {
