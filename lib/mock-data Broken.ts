    ...
    resources: [
      {
        ...
        description:
          "Occupational therapist specializing in home fall-risk assessment for Care Members",
      ...
      },
      {
        ...
        description:
          "Free home safety checks and grab-bar installation for qualifying Care Members",
        estimatedCost: "$0",
...
// ─────────────────────────────────────────────────────────────────────────────
// SECTION 9: SEED DATA — Care Members (assembled from above)
// ─────────────────────────────────────────────────────────────────────────────

export const MOCK_SENIORS: Care Member[] = [
  {
    id: "senior-001",
    name: "Eleanor Yang",
    age: 78,
...
// Used by components that need to find a Care Member or alert by ID quickly
// ─────────────────────────────────────────────────────────────────────────────

export function getSeniorById(id: string): Care Member | undefined {
